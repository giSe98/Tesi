...
MidoriDatabaseItem* midori_database_item_construct (GType object_type,
                                                    ...
                                                    const gchar* title,
                                                    gint64 date);
static void __lambda7_ (MidoriDatabaseItem* self,
                 GParamSpec* pspec);
...
static void ___lambda8_ (MidoriDatabase* self,
                  const gchar* sql,
                  guint64 nanoseconds);
static void ____lambda8__sqlite_profile_callback (gpointer self,
                                           const gchar* sql,
                                           guint64 time);
...
void midori_database_set_first_use (MidoriDatabase* self,
                                    gboolean value);
static gboolean ___lambda10_ (MidoriDatabase* self);
...
static void
__lambda7_ (MidoriDatabaseItem* self,
            GParamSpec* pspec)
{
	MidoriDatabase* _tmp0_;
...
{
#line 159 "/home/test/core/core/database.vala"
	__lambda7_ ((MidoriDatabaseItem*) self, pspec);
...
#line 159 "/home/test/core/core/database.vala"
	g_signal_connect_object ((GObject*) self, "notify::title", (GCallback) ___lambda7__g_object_notify, self, 0);
#line 155 "/home/test/core/core/database.vala"
	return self;
...
static void
___lambda8_ (MidoriDatabase* self,
             const gchar* sql,
             guint64 nanoseconds)
{
...
static void
____lambda8__sqlite_profile_callback (gpointer self,
                                      const gchar* sql,
                                      guint64 time)
{
#line 269 "/home/test/core/core/database.vala"
	___lambda8_ ((MidoriDatabase*) self, sql, time);
...
static gboolean
___lambda10_ (MidoriDatabase* self)
{
	gboolean result = FALSE;
	gint64 _tmp0_;
...
{
	gboolean result;
	result = ___lambda10_ ((MidoriDatabase*) self);
...
#line 269 "/home/test/core/core/database.vala"
		_tmp45_ = self->db;
#line 269 "/home/test/core/core/database.vala"
		sqlite3_profile (_tmp45_, ____lambda8__sqlite_profile_callback, self);
...
#line 312 "/home/test/core/core/database.vala"
	if (!_tmp108_) {
#line 314 "/home/test/core/core/database.vala"
		g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) (60 * 60), ____lambda10__gsource_func, g_object_ref (self), g_object_unref);
...
#line 329 "/home/test/core/core/database.vala"
		self = _data2_->self;
#line 329 "/home/test/core/core/database.vala"
		_g_bytes_unref0 (_data2_->schema);
#line 329 "/home/test/core/core/database.vala"
		_g_object_unref0 (self);
#line 329 "/home/test/core/core/database.vala"
...
#line 331 "/home/test/core/core/database.vala"
		midori_database_transaction (self, ____lambda9__midori_database_callback, _data2_, &_inner_error0_);
#line 331 "/home/test/core/core/database.vala"
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
#line 331 "/home/test/core/core/database.vala"
			block2_data_unref (_data2_);
